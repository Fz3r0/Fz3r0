...
- [`Parte 7` - Objects: `Address`, `Schedule` & `Service`](https://github.com/Fz3r0/Fz3r0/blob/main/Networking/Fortinet/FortiGate/FortiGate7.0_Ude_Lab/00_FG7.0_Fz3r0_Writeup_v1.0.md#fortigate-70---parte-7---objects-address-schedule--service)
...
### Sombras del ciberespacio: la batalla por el control de datos y conocimiento _(por Fz3r0)_

"Corre el año 2023, la era post-pandemia y continuación de "la era digital o era del conocimiento" donde la humanidad ha explotado el espacio virtual conocido como 'Internet', una red informática que conecta al mundo entero, evolución de la red militar ARPAnet, con el paso de las décadas ha evolucionado hasta lograr avances en conexiones basadas en el protocolo TCP/IP utilizando fibra de alta velocidad y capacidad que se mueven casi a la velocidad de la luz, así comunicación inalámbrica con capacidades de un control avanzado en un amplio espectro de frecuencias electromagnéticas y complejos

Este espacio se caracteriza por la alta velocidad de las comunicaciones y capacidad de transferencia de datos que ha transformando desde el entorno social en el que vivimos, hasta nuestra forma de interactuar como especie. El Internet y la naturaleza humana con sed de destrucción han convertido de este un mundo distópico donde la comunicación remota via túneles VPN mueven al mundo, los ataques cibernéticos son la norma y la seguridad informática y los datos digitales son un bien valioso y codiciado. Las batallas se han dejado de dividir solo por tierra, aire y mares, los frentes ahora incluyen las redes informáticas, los datos y el espacio.

El ciber crimen ha evolucionado en los últimos años y ha alcanzado un nivel de sofisticación y alcance global, los hackers más preparados y las inteligencias artificiales avanzadas compiten en una carrera constante para controlar la información y los sistemas de seguridad, no estar al día representa un alto riesgo de sufrir ataques automatizados en segundos, países enteros y sus armadas han sido víctimas de ataques utilizando conocidos frameworks como Cobalt Strike y servidores de Command and Control donde se ha visto comprometida su información confidencial y se han presentado interrupción y pérdida de sus servicios. Naciones enteras han sido victimas de espionaje masivo como han sido los ataques de Pegasus. Las empresas más importantes a nivel global han sido victimas de ataques persistentes donde los threads actors pueden moverse libremente y con lateralidad en sus redes internas y así exfiltrar su valiosa información, industrias de todo tipo se han visto comprometidas por ataques de ransomware y no es dificil encontrar bases de datos con sus padrones enteros en la dark web. 

La búsqueda por `exploits` para `vulnerabilidades 0 day` se ha vuelto una carrera entre `black hats` par así cometer ciberataques y robar información confidencial, también son utilizados por Gobiernos para llevar a cabo operaciones de espionaje o interrupción de servicios enemigos o incluso se han vuelto la moneda de cambio, donde comerciantes y cazadores de exploits venden o licitan vulnerabilidades a los más altos postores, muchas veces sin importar los fines. <br>

En medio de esta lucha, solo aquellos con conocimientos avanzados en infraestructuras de seguridad informática defensiva, como los `Next Generation Firewall (NGFW)`, tienen la capacidad de proteger su información y mantenerse un paso adelante de los inminentes ataques. Para mantener el control de las máquinas y los sistemas, es nuestro deber volvernos expertos, tener el conocimiento y desarrollar las habilidades necesarias para implmentar, configurar y administrar este tipo de infraestructura y así mantenernos seguros en un mundo incierto... <br>

Es importante estar siempre alerta y tomar medidas de seguridad para proteger nuestros sistemas y datos... y así proteger a los nuestros... porque... yo soy Fz3r0 💀... y el Sol no volverá a salir nunca más... "
...
Los NGFW, como los equipos Fortigate de Fortinet, representan una evolución en la protección de la información y los sistemas informáticos, ofreciendo una defensa integral contra los ataques cibernéticos más sofisticados. 
...
- Nota: Otra manera de darse cuenta es verificando el `hitcount` de esa policy:
...
- Por ejemplo, para ver `estáticas`:
...
2. **Las `policy routes` se obtienen con `diagnose firewall proute list`:**
