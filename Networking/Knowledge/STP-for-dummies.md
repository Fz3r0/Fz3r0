...
- _If there are 2 switches in the same "level" and centered (for example 2 switches at distribution layer), take the switch with less charge of work, or newest, or shiny!...if everything is the same...usually engineers choose "left center" switch._ 
