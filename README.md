...
<!-- POEMA: DRACULA DE BRAM STOKER, MODIFICADO Y CON ARREGLOS POR FZ3RO -->
...
<span align="center"> <p align="center"> _**...Enter freely and of your own free will..."**_  </p> </span>  <br>
...
- [Channel Bonding in WiFi](https://www.youtube.com/watch?v=_sI10SiJNfA) _@ Leo's Tech Talk_
...
- [Leo's Tech Talk Wireless Library](https://www.youtube.com/watch?v=sf7tJvwvngQ&list=PLPHjQ2v1B2TfJumy_OBBghOgS2_AJnzHz)
...
- [Frame Control]()
    - [Protocol Version]()
    - [Type]() _Info: Control, Data or Management Frame_
    - [Subtype]() _Info: (specific type) p.e Type-Data >>> Subtype-QoS_
    - [To DS]()
    - [From DS]()
    - [More Fragments]()
    - [Retry]()
...
- [BSS coloring - 802.11ax o wifi 6](https://www.youtube.com/watch?v=Uu9-pxihgjw) _@ Ruckus_

---

- [802.11n protection mechanisms](https://www.cwnp.com/802-11n-protection-mechanisms-part-1/)
...
- [Understanding WLAN Coverage - A CWNP Webinar](https://www.youtube.com/watch?v=OxIgN6jXYn8)
...
- Fortigate Labs Campechanos
    ...
    - [SD-WAN en FortiGate - Redundancia con 2 o más ISP/Carriers](https://www.youtube.com/watch?v=JMzJ7SEXf5g)
...
- Commscope Ruckus
    ...
    - ICX > [Ruckus **Stacking**: Lab Demo CLI Basics & Stacking](https://www.youtube.com/watch?v=epoHUOLM12Q)
    ...
    - ICX > [Configuring **Link Aggregation Group** (**LAG**)](https://docs.ruckuswireless.com/fastiron/08.0.60/fastiron-08060-l2guide/GUID-FE4D29C9-59DC-4394-98CE-DCBD3FA7EC48.html) 
    ...
    - ICX > [Configuring **DHCP Server** on **Brocade ICX**](https://www.youtube.com/watch?v=AXCPDVptsyk)
    - ICX > [Configuring **DHCP Snooping*](https://www.youtube.com/watch?v=IeixpKeoAZI)
...
- **Wireless Threats & Attacks**
    ...
    - [Rogue Access Point - Evil Twin](https://www.youtube.com/watch?v=1w77F4jH9ac)
...
- Wired
    ...
    - [curl](https://curl.haxx.se/) – transfer data with URLs. (alternatives [aria2](https://github.com/aria2/aria2), [httpie](https://httpie.org/))
    - [darkstat](https://unix4lyfe.org/darkstat/) – Captures network traffic, calculates statistics, and serves  reports over HTTP.
    - [dhclient](https://linux.die.net/man/8/dhclient) – Dynamic Host Configuration Protocol Client.
    - [dhcpcd](https://wiki.archlinux.org/index.php/Dhcpcd) \- RFC2131 compliant DHCP client daemon.
    - [dig](https://linux.die.net/man/1/dig) – DNS lookup utility.
    - [dstat](https://github.com/dagwieers/dstat) – A versatile resource statistics tool.
    ...
    - [ip](https://access.redhat.com/sites/default/files/attachments/rh_ip_command_cheatsheet_1214_jcs_print.pdf) (PDF file) – ifconfig on steroids.
    ...
    - [iptables](https://netfilter.org/) – utility for configuring Linux kernel [firewall](https://wiki.archlinux.org/index.php/Firewall).
    - [IPTraf](https://sourceforge.net/projects/iptraf-ng/) – Console-based network monitoring utility.
    - [iputils](https://wiki.linuxfoundation.org/networking/iputils) – Network monitoring tools, including ping.
    ...
    - [jwhois](https://github.com/jonasob/jwhois/) ( improved whois) – client for the whois service.
    ...
    - [net-tools](http://net-tools.sourceforge.net/) – the collection of base networking utilities for Linux.
    - [ncat](https://nmap.org/ncat/) – much-improved re-implementation of the venerable [Netcat](http://sectools.org/tool/netcat/).
    - [nethogs](https://github.com/raboof/nethogs) – Linux 'net top' tool written in C++.
    - [Netperf](https://github.com/HewlettPackard/netperf) – Network bandwidth benchmark.
    - [netsniff-ng](http://netsniff-ng.org/) – Swiss army knife for your daily Linux network plumbing if you will.
    - [netstat](http://net-tools.sourceforge.net/man/netstat.8.html) – Print network connections, routing tables, interface statistics, masquerade connections, etc.
    - [netwatch](http://www.slctech.org/~mackay/NETWATCH/netwatch.html) – monitor network connections.
    - [ngrep](https://github.com/jpr5/ngrep/) – ngrep is like GNU grep applied to the network layer.
    - [nload](http://www.roland-riegel.de/nload) – Monitors network traffic and bandwidth usage.
    - [nmap](https://nmap.org/) – Nmap ("Network Mapper") utility for network discovery and security auditing.
    - [nmcli](https://developer.gnome.org/NetworkManager/stable/nmcli.html) – command-line tool for controlling [NetworkManager](https://wiki.gnome.org/Projects/NetworkManager).
    - [nmtui](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html/Networking_Guide/sec-Networking_Config_Using_nmtui.html) – provides a text interface to configure networking by controlling [NetworkManager](https://wiki.gnome.org/Projects/NetworkManager).
    - [nslookup](https://en.wikipedia.org/wiki/Nslookup) – for querying DNS to obtain [domain name](https://en.wikipedia.org/wiki/Domain_name) or [IP address](https://en.wikipedia.org/wiki/IP_address) mapping. (alternatively [dnslookup](https://github.com/ameshkov/dnslookup))
    - [openssl](https://www.openssl.org/) \- The Open Source toolkit for SSL and TLS protocols.
    - [openvpn](https://openvpn.net/index.php/open-source.html) \- robust and highly configurable VPN
    - [paping](https://github.com/rampageX/paping) \- TCP ping on specific port.
    - [ping](https://en.wikipedia.org/wiki/Ping_(networking_utility)) – send icmp echo\_request to network hosts.
    - [iproute2](https://git.kernel.org/pub/scm/network/iproute2/iproute2.git) (route) – show / manipulate the IP routing table.
    - [slurm](https://github.com/mattthias/slurm) – yet another network load monitor.
    - [snort](https://www.snort.org/) – A lightweight network intrusion detection system.
    - [smokeping](https://oss.oetiker.ch/smokeping/) –  A tool to keep track of your network latency.
    - [socat](http://www.dest-unreach.org/socat/) – relay for bidirectional data transfer between two independent data channels
    - [ss](http://linux-ip.net/gl/ss/) – another utility to investigate sockets.
    - [ssh](https://linux.die.net/man/1/ssh) –  the infamous Secure Shell protocol.
    - [speedometer](http://excess.org/speedometer/) – Measure and display the rate of data across a network connection or data being stored in a file.
    - [speedtest-cli](https://github.com/sivel/speedtest-cli) – for testing internet bandwidth using speedtest.net.
    - [systemd-networkd](https://wiki.archlinux.org/index.php/Systemd-networkd) \- a system daemon that manages network configurations.
    ...
    - [telnet](https://www.unix.com/man-page/linux/1/telnet/) – User interface to [TELNET](https://en.wikipedia.org/wiki/Telnet).
    - [tracepath](https://linux.die.net/man/8/tracepath) – traces path to a network host discovering MTU along this path (similar  traceroute)
    - [traceroute](http://traceroute.sourceforge.net/) – Tracks the route taken by packets over an IP network.
    - [vnStat](https://humdi.net/vnstat/) – A console-based network traffic monitor.
    - [websocat](https://github.com/vi/websocat) – CLI client for web sockets, like netcat/curl/socat for ws://
...
- [Bruteshark](https://github.com/Fz3r0/BruteShark)
    ...
    - **IDS & IPS**
        ...
        - [Snort]() _The foremost IPS in the world supported by Cisco Talos_
            ...
            - [Snort > Instalación(1) en Kali y Configuración @ D.Pereira](https://www.youtube.com/watch?v=ap6TGO6PyIM&list=PL1Kv5m-HTbQzuWFK1GpjB3IHJHgnsAoS6&index=2)
            - [Snort > Instalación(2) {error fixes}](https://koayyongcett.medium.com/snort-installation-in-kali-linux-from-the-source-9a005558a2ea)
            - [Snort > Install on Debian {error fixes II}](https://upcloud.com/resources/tutorials/installing-snort-on-debian)
...
- [Pentest Cheatsheet God](https://github.com/OlivierLaflamme/Cheatsheet-God)
...
- [Cobalt.io](https://www.cobalt.io/blog) _Modern pentesting for security and development teams_
...
### SQLi Tutorials & Guides

- [SQL Injection and WAF Bypass](https://youtu.be/B23_7GNEcVQ) _@ CyberSecurityTV_

### SQLi Bibles, Cheatsheets & Resources
...
- [SQL Map]()
- [DH Hackbar](https://github.com/darknethaxor/DH-HackBar)
...
- [Visual PAradigm Online](https://online.visual-paradigm.com/app/diagrams/#diagram:proj=0&type=ERDiagram&width=11&height=8.5&unit=inch) _Free Online Entity-Relation Diagram creator (no register, ready to go!)_
...
- MySQL Installation, Cheatsheets & Guides
    ...
    - [MySQL CC by @ Fz3r0](/Databases/MySQL/MySQL-CC-Fz3r0.md) _My super CC Writeup!_
