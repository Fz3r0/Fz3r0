...
- Then, we will copy ALL the badchars code _(you can include badchars =)_ to a new python script (or re-use the same of last task)

- Just change the following this time:
